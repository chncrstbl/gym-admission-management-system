...
const Login = () => {
    ...
    return (
        <div className="min-h-screen w-full flex flex-col md:flex-row bg-[#f8fafc] font-sans">
            ...
            {/* Left Panel */}
            <div className="relative w-full md:w-1/2 bg-gradient-to from-[#041a5f] via-[#01358a] to-[#0078d7] flex flex-col justify-center p-8 md:p-10 lg:p-20 text-white overflow-hidden min-h-[45vh] md:min-h-screen">
